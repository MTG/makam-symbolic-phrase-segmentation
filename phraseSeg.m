...
if inputErr
    errstr = ['Wrong inputs! \n'...
        ...
        '     ** Note: The json file should have be a list of dictionaries with the path and name fields. Path is the filepath and name stands for the symbtr filename of the score.\n'...        
