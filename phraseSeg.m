...
if inputErr
    dispstr = ['Usage: \n'...
        '  Training Wrapper ................ "phraseSeg trainWrapper trainFolder/trainFilesJson boundStatFile FLDmodelFile (trainFeatureFolder)" \n'...
        '  Segmentation Wrapper ............ "phraseSeg segmentWrapper boundStatFile FLDmodelFile testFile/testFileJson testSegmentFolder (testFeatureFolder)" \n'...
        '     ** Note: The json file should be a list of dictionaries with the path and name fields. Path is the filepath and name stands for the symbtr filename of the score.\n'...        
        'Individual functions: \n'...
        '  Learn boundary statistics ....... "phraseSeg learnBoundStat noteTableFile [outFile]" \n'...
        '  Feature Extraction............... "phraseSeg extractFeature (scoreFolder/scoreFile) boundStatFile [outFolder/outFile]" \n'...
        '  Training ........................ "phraseSeg train trainingFolder [outFolder]" \n'...
        '  Segmentation .................... "phraseSeg segment (testFolder/testFile) FLDmodelFile [outFolder/outFile]" \n'...
        '  Evaluation ...................... "phraseSeg evaluate [evaluateFolder/evaluateFile] [plotROC]" \n'...
        'Extras: \n'...
        '  Help     ........................ "phraseSeg help" \n'...
        '  Test run ........................ "phraseSeg unitTest" \n'...
        '  Get manual segments in SymbTr ... "phraseSeg getSegments (scoreFolder/scoreFile) [outFolder/outFile]" \n'];
    if strcmp(varargin{1}, 'help')
        fprintf(dispstr)
        return
    else
        dispstr = ['Wrong inputs! \n' dispstr];
        error('makamSymPhraseSeg:input', dispstr)
    end
end
